...
// For woocommerce
function vsfed_WooCommerce_register_required_plugins() {
	...
	if (vsfed_WooCommerce_addon_install()) {
		...
		$bwd_w_plugin_the_notice_is = '<p><b>View Social Feeds</b> requires WooCommerce to be activated.</p>';
		...
		$bwd_w_plugin_the_notice_is = '<p><b>View Social Feeds</b> requires WooCommerce to be installed and activated.</p>';
...
function vsfed_WooCommerce_addon_install() {
...
// For elementor 
function vsfed_products_register_required_plugins() {
	...
	if (vsfed_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>View Social Feeds</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>View Social Feeds</b> requires Elementor to be installed and activated.</p>';
...
function vsfed_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>View Social Feeds</b> does not work since you are using an older version of Elementor</p>';
